...
**Twitter Demo** is an android app that allows a user to view home and mentions timelines, view user profiles with user timelines, as well as compose and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
* [x] automatically simplifies number of followers to be 2.45m or 234k (not 2453129 or 234297)
* [x] includes mentions tab in profile view
* [x] added coverphoto
